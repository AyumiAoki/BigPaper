...
public class TelaFunRelVenda extends JPanel{
    ...
    public TelaFunRelVenda(final BigPaper jf) {
        ...
        fundo = new ImageIcon("src/imagens/fundoTelas/fundoFunRelVenda.png");
        ...
        btnRelVenda = new JButton(iconSelecionado);
